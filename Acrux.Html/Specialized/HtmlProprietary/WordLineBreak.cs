...
namespace Acrux.Html.Specialized.HtmlProprietary
{
    ...
    /// 
    /// </summary>
    [HtmlTagAttributesMapper(TagName = "WBR")]
    public sealed class WordLineBreak : HtmlElement
    {
        internal WordLineBreak(string prefix, string localName, string namespaceURI, HtmlDocument doc, bool isEmptyTag, NodePosition parsedPosition)
