...
namespace Acrux.Html.Specialized.Html401
{
    ...
    /// 
    /// </summary>
    [HtmlTagAttributesMapper(TagName = "H6")]
    public sealed class HeadingLevel6 : HtmlElement
    {
        internal HeadingLevel6(string prefix, string localName, string namespaceURI, HtmlDocument doc, bool isEmptyTag, NodePosition parsedPosition)
