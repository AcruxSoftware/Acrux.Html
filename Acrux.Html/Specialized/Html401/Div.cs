...
namespace Acrux.Html.Specialized.Html401
{
    ...
    /// </summary>
    [HtmlTagAttributesMapper(TagName = "DIV")]
    public sealed class Div : HtmlElement
    {
        internal Div(string prefix, string localName, string namespaceURI, HtmlDocument doc, bool isEmptyTag, NodePosition parsedPosition)
        ...
        private static List<string> s_ResetTags = 
