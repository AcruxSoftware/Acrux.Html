...
namespace Acrux.Html.Specialized.Html401
{
    ...
    /// </summary>
    [HtmlTagAttributesMapper(TagName = "SUB")]
    public sealed class SubScript : HtmlElement
    {
        internal SubScript(string prefix, string localName, string namespaceURI, HtmlDocument doc, bool isEmptyTag, NodePosition parsedPosition)
