...
namespace Acrux.Html.Specialized.Html401
{
    ...
    /// <summary>
    /// &lt;!ELEMENT TFOOT    O O (TR)+           -- table body --&gt;
    ///
    ...
    /// 
    /// </summary>
    [HtmlTagAttributesMapper(TagName = "TFOOT")]
    public sealed class TableFooter : HtmlElement
    {
        internal TableFooter(string prefix, string localName, string namespaceURI, HtmlDocument doc, bool isEmptyTag, NodePosition parsedPosition)
