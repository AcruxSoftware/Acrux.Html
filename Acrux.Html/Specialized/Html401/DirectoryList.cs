...
namespace Acrux.Html.Specialized.Html401
{
    ...
    /// </summary>
    [HtmlTagAttributesMapper(TagName = "DIR")]
    public sealed class DirectoryList : HtmlElement
    {
        internal DirectoryList(string prefix, string localName, string namespaceURI, HtmlDocument doc, bool isEmptyTag, NodePosition parsedPosition)
