...
namespace Acrux.Html.Specialized.Html401
{
    ...
    /// </summary>
    [HtmlTagAttributesMapper(TagName = "SUP")]
    public sealed class SuperScript : HtmlElement
    {
        internal SuperScript(string prefix, string localName, string namespaceURI, HtmlDocument doc, bool isEmptyTag, NodePosition parsedPosition)
