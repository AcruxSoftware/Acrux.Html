...
namespace Acrux.Html.Specialized.Html401
{
    ...
    /// 
    /// </summary>
    [HtmlTagAttributesMapper(TagName = "LI")]
    public sealed class ListItem : HtmlElement
    {
        internal ListItem(string prefix, string localName, string namespaceURI, HtmlDocument doc, bool isEmptyTag, NodePosition parsedPosition)
        ...
        { get { return new string[] { "UL", "OL", "DIR", "MENU" }; } }
