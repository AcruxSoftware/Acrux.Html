...
namespace Acrux.Html.Specialized.Html401
{
    ...
    /// 
    /// </summary>
    [HtmlTagAttributesMapper(TagName = "FONT")]
    public sealed class Font : HtmlElement
    {
        internal Font(string prefix, string localName, string namespaceURI, HtmlDocument doc, bool isEmptyTag, NodePosition parsedPosition)
