...
namespace Acrux.Html.Specialized.Html401
{
    ...
    /// </summary>
    [HtmlTagAttributesMapper(TagName = "LEGEND")]
    public sealed class FieldsetLegend : HtmlElement
    {
        internal FieldsetLegend(string prefix, string localName, string namespaceURI, HtmlDocument doc, bool isEmptyTag, NodePosition parsedPosition)
