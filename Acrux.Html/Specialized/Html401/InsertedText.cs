...
namespace Acrux.Html.Specialized.Html401
{
    ...
    /// 
    /// </summary>
    [HtmlTagAttributesMapper(TagName = "INS")]
    public sealed class InsertedText : HtmlElement
    {
        internal InsertedText(string prefix, string localName, string namespaceURI, HtmlDocument doc, bool isEmptyTag, NodePosition parsedPosition)
            : base(prefix, localName, namespaceURI, doc, isEmptyTag, parsedPosition)
        { }

        // TODO: Test this in a browser:
        // 
        //  <P>
        //  <INS><DIV>...block-level content...</DIV></INS>
        //  </P>
        //
        //  Think about what to do with them (and the fact they can be either block-level or inline elements)
        //  Try to find more info about how to determine when they behave as block-level and when as inline?
