...
namespace Acrux.Html.Specialized.Html401
{
    ...
    /// 
    /// </summary>
    [HtmlTagAttributesMapper(TagName = "TH")]
    public sealed class TableHeaderCell : HtmlElement
    {
        internal TableHeaderCell(string prefix, string localName, string namespaceURI, HtmlDocument doc, bool isEmptyTag, NodePosition parsedPosition)
        ...
        // TODO: For unit tests try:
        // 
        // <TR>   <TD>   <A HREF="#"> <TR>    (The TR should correctly be considered as a new TR closing the optional TD and detecting invalid <A> tag as well
    }
}
